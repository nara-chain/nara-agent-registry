...
/// Global PDA that tracks all pending tweet verification requests.
/// Seeds: [b"tweet_verify_queue"]
///
...
#[account(zero_copy)]
#[repr(C)]
pub struct TweetVerifyQueue {
    /// Number of TweetVerify PDA addresses currently pending verification.
    pub len: u64,
}

impl TweetVerifyQueue {
